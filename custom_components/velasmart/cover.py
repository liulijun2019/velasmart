...
from .api import VelaSmartApiClient
...
class VelaSmartCover(CoordinatorEntity, CoverEntity):
    ...
    def __init__(
        ...
        self._gateway_mac: str = device["gateway_mac"]
    ...
    async def async_open_cover(self, **kwargs: Any) -> None:
        """Open the curtain."""
        await self._client.send_command(self._device_id, self._gateway_mac, 100)
    ...
    async def async_close_cover(self, **kwargs: Any) -> None:
        """Close the curtain."""
        await self._client.send_command(self._device_id, self._gateway_mac, 0)
    ...
    async def async_set_cover_position(self, **kwargs: Any) -> None:
        ...
        if position is None:
            return
        await self._client.send_command(self._device_id, self._gateway_mac, position)
